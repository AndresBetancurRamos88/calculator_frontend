    ...
    <div class="wrapper fadeInDown">
      <div id="formContent">
        <div class="fadeIn first">
          <img src="@/assets/calculator.png" id="icon" alt="User Icon" style="margin-top: 20px;"/>
        </div>
  ...
  methods:{
    async login(){
      try {
        ...
        const secrets = `${this.clientID}:${this.clientSecret}`;
        const base64Encoded = btoa(String.fromCharCode(...new Uint8Array(encoder.encode(secrets))));
        ...
        if (error.response) {
          ...
          this.error_msg = "Server is not available.";
        }
      } finally {
        this.spinner = false;
      }

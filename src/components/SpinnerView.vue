<template>
  <div id ='jqxLoaderinicio' class="jqxLoader">
...
.logo {
  background: url("@/assets/calculator.png") no-repeat 50%/50%;
  width: 100%;
  height: 100%;
...
.codepad-logo {
  ...
  width: 100px;
  height: 100px;
  color: rgba(0,68,140,0.9);
  border-radius: 6px;
  box-shadow: inset 0 0 0 1px rgba(0,68,140,0.9) ;
  transform: rotate(45deg);
  background: #fff;
  z-index: 10;
